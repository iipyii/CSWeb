...
const facultyMembers = [
  ...
  { name: "รศ.ดร.กฤดาภัทร สีหารี", role: "", image: "/img/staff/kridaohat.jpg" },
  { name: "รศ.ดร.กอบเกียรติ สระอุบล", role: "", image: "/img/staff/kobkiat.jpg" },
  { name: "รศ.ดร.ปรวัฒน์ วิสูตรศักดิ์", role: "", image: "/img/staff/prawat.jpg" },
  { name: "รศ.ดร.เบญจพร ลิ้มธรรมาภรณ์", role: "", image: "/img/staff/benjaporn.jpg" },
  { name: "ผศ.ดร.อัครา ประโยชน์", role: "", image: "/img/staff/akara.jpg" },
  { name: "ผศ.ดร.สุวัจชัย กมลสันติโรจน์", role: "", image: "/img/staff/suwatchai.jpg" },
  { name: "อาจารย์ ปรัชญาพร เลี้ยงสุทธิสกนธ์", role: "", image: "/img/staff/parinyaporn.jpg" },
  ...
  { name: "อาจารย์ อนุสรณ์ วงษ์สนิท", role: "", image: "/img/staff/kridaohat.jpg" },
  { name: "รศ.ดร.เฉียบวุฒิ รัตนวิไลสกุล", role: "", image: "/img/staff/kobkiat.jpg" },
  { name: "อาจารย์ ดร.ยนต์ชนก เขาแก้ว", role: "", image: "/img/staff/prawat.jpg" },
  { name: "ผศ.สถิตย์ ประสมพันธ์", role: "", image: "/img/staff/benjaporn.jpg" },
  { name: "อาจารย์ เอิญ สุริยะฉาย", role: "", image: "/img/staff/akara.jpg" },
  { name: "ผศ.ดร.ธรรศฏภณ สุระศักดิ์", role: "", image: "/img/staff/suwatchai.jpg" },
  { name: "อาจารย์ ดร.ณัฐกิตติ์ จิตรเอื้อตระกูล", role: "", image: "/img/staff/parinyaporn.jpg" }
];
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <section className="mb-24 text-center">
          ...
          <div className="flex justify-center mb-16">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="w-72 group">
              ...
              <h3 className="font-bold text-xl text-slate-800">{headOfDepartment.name}</h3>
          ...
          <div className="flex justify-center mb-20">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="w-64 group">
              ...
              <h3 className="font-bold text-lg text-slate-800">{deputyHead.name}</h3>
              <p className="text-[#3F51B5] font-medium text-sm">{deputyHead.role}</p>
            </motion.div>
          </div>

          {/* แถวที่ 3: ผู้ช่วยหัวหน้าภาควิชา (ปรับรูปใหญ่ขึ้น) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {assistants.map((staff, idx) => (
              <motion.div key={idx} variants={fadeInUp} initial="hidden" whileInView="visible" className="group">
                ...
                <h4 className="font-bold text-slate-800 mb-1 leading-tight">{staff.name}</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {facultyMembers.map((staff, idx) => (
              <motion.div key={idx} variants={fadeInUp} initial="hidden" whileInView="visible" className="group">
                ...
                <h4 className="font-bold text-slate-800 mb-1 text-sm">{staff.name}</h4>
                <p className="text-[11px] text-[#3F51B5] font-medium">{staff.role}</p>
              </motion.div>
            ))}
          </div>
        </section>
